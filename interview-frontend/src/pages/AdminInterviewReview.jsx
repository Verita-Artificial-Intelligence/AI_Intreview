      ...
      <div className={pageHeader.wrapper}>
        <div className={`${containers.lg} ${pageHeader.container}`}>
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className={pageHeader.title}>Interview Analysis</h1>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card className={`p-6 ${cardStyles.default}`}>
              <div className="flex items-center gap-4 mb-4">
                <div className="w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold text-white bg-gradient-to-br from-brand-400 to-brand-600">
              ...
              <div className="mt-4 pt-4 border-t border-neutral-200">
                ...
                <div className="flex flex-wrap gap-2">
                  {candidate.skills.map((skill, index) => (
                    <span
                      key={index}
                      className="px-3 py-1 rounded-full text-xs font-medium bg-purple-50 text-purple-600"
                    >
                      {skill}
                    </span>
                  ))}
              ...
              <div className="mt-4 pt-4 border-t border-neutral-200">
                <p className="text-sm font-medium text-neutral-700 mb-2">Bio</p>
            ...
            {/* Interview Metadata */}
            <Card className={`p-6 ${cardStyles.default}`}>
              <h3 className="font-bold text-lg mb-4 text-neutral-900">
                Interview Details
              </h3>
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-center">
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${getScoreColor(analysis?.overall_score || 0)} 0%, ${getScoreColor(analysis?.overall_score || 0)}dd 100%)`,
                    }}
                  >
                    {analysis?.overall_score || 0}
                  </div>
                  <p className="text-xs text-neutral-600">out of 10</p>
                </div>
              </div>
            </Card>
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-3">
                        <span
                          ...
                          style={{
                            background: `${getScoreColor(skill.score)}15`,
                    ...
                    <div>
                      ...
                      <div className="space-y-1 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {analysis.communication_assessment.confidence_score}
                            /10
                          </span>
                        </div>
                      </div>
            ...
            <Card className={`p-6 ${cardStyles.default}`}>
              ...
              <div
                ...
                style={{
                  background: `${getRecommendationColor(analysis?.recommendation)}15`,
                }}
              >
                <div>
                  <p
