        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              required
              className="mt-1 h-8 text-sm rounded-lg border-neutral-300 focus:border-brand-500 focus:ring-2 focus:ring-brand-200"
              placeholder="e.g. Sound Designer, Video Editor, Motion Designer"
            />
          </div>
          ...
          <div>
            ...
            <div className="mt-1 flex gap-1.5">
              <Input
                ...
                placeholder="e.g. After Effects, Pro Tools, Blender, etc."
              />
              <Button
                type="button"
                onClick={addSkill}
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Tell us about your creative background, notable projects, and the type of work you're most passionate about..."
            />
          </div>
          ...
          >
            {loading ? 'Saving Profile...' : 'Continue to Interview Prep'}
          </Button>
        </form>
