      ...
      <div className={`${containers.lg} mx-auto px-6 py-8`}>
        ...
        <div className="mb-8">
          <div className="relative max-w-2xl">
            ...
            <Input
              ...
              className="pl-12 h-12 rounded-lg border-neutral-300 focus:border-brand-500 focus:ring-2 focus:ring-brand-200 text-base"
            />
          </div>
        </div>
        ...
        {loading ? (
          ...
          <Card className={`p-12 text-center ${cardStyles.default}`}>
            ...
            <p className="text-neutral-600 text-lg">No candidates found</p>
          </Card>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCandidates.map((candidate) => (
              <Card key={candidate.id} className={`p-6 ${cardStyles.default}`}>
                <div className="mb-4">
                  <div className="w-16 h-16 rounded-full flex items-center justify-center mb-3 text-2xl font-bold text-white bg-gradient-to-br from-brand-400 to-brand-600">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {candidate.skills.length > 4 && (
                      <span className="px-3 py-1 rounded-full text-xs font-medium bg-neutral-100 text-neutral-600 border border-neutral-200">
                        +{candidate.skills.length - 4}
                      </span>
                    )}
                  </div>
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    className="flex-1 rounded-lg font-medium text-sm bg-brand-500 hover:bg-brand-600 text-white"
                  >
                    Text
                  </Button>
                  <Button
                    ...
                    className="flex-1 rounded-lg font-medium text-sm bg-blue-500 hover:bg-blue-600 text-white"
                  >
                    Voice
                  </Button>
                </div>
            ...
            <div className="space-y-4 py-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    className={`flex-1 rounded-lg ${interviewType === 'audio' ? 'bg-blue-500 hover:bg-blue-600 text-white' : 'border-neutral-300'}`}
                  >
                    Voice Call
                  </Button>
                </div>
              ...
              <div className="flex gap-3 pt-4">
                ...
                <Button
                  ...
                  disabled={startingInterview}
                  className={`flex-1 rounded-lg font-medium ${interviewType === 'audio' ? 'bg-blue-500 hover:bg-blue-600' : 'bg-brand-500 hover:bg-brand-600'} text-white`}
                >
