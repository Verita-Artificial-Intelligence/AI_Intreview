            ...
            >
              ...
              >
                {message.role === 'assistant' && (
                  <p className="text-xs font-medium mb-1" style={{ color: '#667eea' }}>AI Interviewer</p>
                )}
          ...
          <div className="max-w-5xl mx-auto px-6 py-4">
            <form onSubmit={handleSendMessage} className="flex gap-3">
              <Input
                ...
                disabled={sending}
                className="flex-1 h-12 rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-base"
              />
              <Button
                type="submit"
      ...
      {interview.status === 'completed' && (
        <div className="bg-white border-t border-gray-200 shadow-lg">
          <div className="max-w-5xl mx-auto px-6 py-6 text-center">
            ...
            <p className="text-gray-600">This interview has been completed and can no longer accept messages.</p>
          </div>
        </div>
      )}
    </div>
