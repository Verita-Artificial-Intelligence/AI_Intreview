              ...
              <div className="mt-3 pt-3 border-t border-neutral-200">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {candidate.skills.map((skill, index) => (
                    <span
                      key={index}
                      className="px-2 py-0.5 rounded-full text-[10px] font-medium bg-purple-50 text-purple-600"
                    >
                      {skill}
                    </span>
                  ))}
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <Card className={`p-4 ${cardStyles.default}`}>
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-bold mb-0.5 text-neutral-900">
                    Overall Assessment
                  </h3>
                ...
                <div className="text-center">
                  <div
                    className="w-16 h-16 rounded-full flex items-center justify-center text-xl font-bold text-white mb-1"
                    style={{
                  ...
                  <p className="text-[10px] text-neutral-600">out of 10</p>
                </div>
              </div>
            </Card>
