...
/**
 * Page header styles - Standardized for all pages
 */
export const pageHeader = {
  // Header without box/border - for most pages
  simple: {
    container: 'mb-8',
    title: 'text-3xl font-display font-bold text-neutral-900 mb-2',
    subtitle: 'text-sm text-neutral-600',
  },
  // Header with box/border - for dashboard only
  boxed: {
    wrapper: 'bg-white border-b border-neutral-100/60 sticky top-0 z-10 shadow-sm',
    container: 'max-w-[1650px] mx-auto px-4 h-[96px] flex items-center justify-between',
    title: 'text-3xl font-display font-bold text-neutral-900 mb-1',
    subtitle: 'text-sm text-neutral-600',
  }
}

/**
 * Standardized page container styles
 */
export const pageContainer = {
  wrapper: 'flex-1 overflow-auto',
  container: 'max-w-[1800px] mx-auto px-8 py-8',
  containerSmall: 'max-w-[1800px] mx-auto px-6 py-6',
}
...
export const searchBar = {
  ...
  input: 'pl-12 h-12 rounded-lg border-neutral-300 focus:border-brand-500 focus:ring-2 focus:ring-brand-200',
  icon: 'absolute left-4 top-1/2 transform -translate-y-1/2 text-neutral-400 w-5 h-5',
}
