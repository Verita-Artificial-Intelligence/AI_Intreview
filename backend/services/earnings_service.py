...
from database import get_earnings_collection, get_annotations_collection, get_jobs_collection
...
class EarningsService:
    ...
    async def get_user_earnings(user_id: str) -> List[Earning]:
        ...
        earnings_docs = await earnings_collection.find(
            {"user_id": user_id},
            {"_id": 0}
    ...
    async def get_earnings_with_details(user_id: str):
        ...
        for earning in earnings:
            ...
            enriched_earnings.append({
                ...
                "task_name": task.get("task_name", "Annotation Task") if task else "Unknown Task",
