...
WS_RECONNECT_MAX_ATTEMPTS = int(os.environ.get("WS_RECONNECT_MAX_ATTEMPTS", "10"))  # Number of reconnection attempts (10 = ~2 minutes)
WS_RECONNECT_MAX_BACKOFF = int(os.environ.get("WS_RECONNECT_MAX_BACKOFF", "15"))  # Max backoff in seconds between attempts
